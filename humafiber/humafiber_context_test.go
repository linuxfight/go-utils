...
import (
	...
	"github.com/linuxfight/go-utils/humafiber"
...
const (
	contextValueFiberUserValue   = "context-fiber-user-value"
	contextValueFiberUserContext = "context-fiber-user-context"
	contextValueHuma             = "context-huma"
)
...
// Update your middleware to use Locals instead of SetUserValue
